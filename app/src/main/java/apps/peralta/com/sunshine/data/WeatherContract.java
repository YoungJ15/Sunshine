...
/**
 * Created by Josermando on 2/14/2016.
 */

//This class defines table and columns name for the weather database
public class WeatherContract {
    //The content authority is a name for the entire content provider
    public static final String CONTENT_AUTHORITY = "com.sunshine.peralta.app";
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);
    public static final String PATH_WEATHER = "weather";
    public static final String PATH_LOCATION = "location";

    public static long normalizeDate(long startDate){
        //Normalize the startDate to the beginning of the day (UTC)
        Time time = new Time();
        time.set(startDate);
    ...
    public static final class LocationEntry implements BaseColumns{
        ...
        //The location_setting will be sent to the openweathermap as the location query

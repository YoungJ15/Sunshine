package apps.peralta.com.sunshine.data;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //Composed by location_settings, city_name, latitude and longitude
        ...
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE "+ WeatherContract.WeatherEntry.TABLE_NAME + " ("+
                ...
                //Setting up the location column as a foreign key to location table
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //This database is only to store online data, so its upgrade policy is to simply discard data and start over
